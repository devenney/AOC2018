...
// firstRepeat executes the input sequence until a frequency is encountered twice,
// iterating more than once if necessary
func firstRepeat(input []int) int {
	var frequency int
